...
import lt.kvk.i12_2.tvakarastis.imageview.SavedImage_Prof_SVMF;
...
//        ww.setInitialScale(1);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.showImage:
                ...
                try{
                    File temp = new File  ("/data/user/0/lt.kvk.i12_2.tvakarastis/files/SVMF_prof.jpg");
    ...
    private void saveImage() {
        ...
        try {
            fos = openFileOutput("SVMF_prof.jpg", Context.MODE_PRIVATE);
            if (fos != null) {
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            progress = new ProgressDialog(DestytojaiSVMF.this);
