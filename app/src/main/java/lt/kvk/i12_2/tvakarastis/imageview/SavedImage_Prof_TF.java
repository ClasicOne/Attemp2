...
public class SavedImage_Prof_TF extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            imageView1.setImageBitmap(BitmapFactory.decodeFile("/data/user/0/lt.kvk.i12_2.tvakarastis/files/TF_prof.jpg"));
